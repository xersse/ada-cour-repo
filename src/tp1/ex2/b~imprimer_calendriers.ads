...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_imprimer_calendriers" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2810db9b#;
   pragma Export (C, u00001, "imprimer_calendriersB");
