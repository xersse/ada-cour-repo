...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_mention_baccalaureat" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#cc77b96d#;
   pragma Export (C, u00001, "mention_baccalaureatB");
