...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_somme_des_entiers" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#eab00829#;
   pragma Export (C, u00001, "somme_des_entiersB");
   ...
   u00138 : constant Version_32 := 16#248a0db1#;
