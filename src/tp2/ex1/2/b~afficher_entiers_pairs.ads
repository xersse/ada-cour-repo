...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_afficher_entiers_pairs" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#eb4e3444#;
   pragma Export (C, u00001, "afficher_entiers_pairsB");
